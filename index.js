...
break
               case 'mia':
					...
					buffer = await getBuffer(`https://ibb.co/yV6YtF8`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
              case 'porno':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/bF3crH0`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
              case 'porno2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/hBVXzTk`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
              case 'belle':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/HrCXD4k`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
               case 'belle2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/gPm28g0`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
             case 'hentai':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/N676dyS`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
            case 'leti':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/jhGRzVT`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
           case 'leti2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/XLpwZ36`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
          case 'leti3':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/Wt84tJF`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
         case 'leti4':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/K9VyYws`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
         case 'leti5':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://ibb.co/m0SHptP`)
					client.sendMessage(from, buffer, image, {quoted: msg, caption: 'hihihi'})
					break
case 'edit1':
